...
public class GuessNum {
        ...
        public static void guessNum() {
            ...
            while( attempts<3 ){
                ...
                if(guess>rand_num) {
                    System.out.println("\nsorry! Your number is less than "+guess+"Please enter again");
                }
            ...
            if(attempts==3) {
                ...
                points=0;
                System.out.println("\nSorry! you are out of chance please try again later. ");
                System.out.println("\nYour score: "+points);
                System.out.println("\nThe number  which You have missed is "+rand_num);
                System.out.println("\nif you want to play again press 1 or else press 2!");
                play_again=sc.nextInt();
